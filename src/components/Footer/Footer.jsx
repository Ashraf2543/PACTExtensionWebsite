        ...
        <div className="footer__content">
          <div className="footer__main">
            <div className="footer__brand">
              <Link to="/" className="footer__logo">
                ...
                <span className="footer__logo-text">ExamMonitor</span>
              </Link>
              <p className="footer__description">
                Ensuring academic integrity through secure and transparent online exam monitoring.
              </p>
            ...
            <div className="footer__links">
              <div className="footer__link-group">
                ...
                <a href="#download" className="footer__link">Download</a>
              ...
              <div className="footer__link-group">
                ...
                <a href="#" className="footer__link">Compliance</a>
              </div>
          ...
          <div className="footer__bottom">
            <div className="footer__copyright">
              &copy; {currentYear} ExamMonitor. All rights reserved.
            </div>
